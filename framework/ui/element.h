    ...
    typedef struct _element_animation_t
    {
        ...
        vector2_t   trans;            /* animation translation change */
        vector2_t   target;           /* animation translation target */
    } element_animation_t;

    typedef struct _element_texture_t
    {
		vector2_t       ulc;           /* upper left texture coordinate */
		vector2_t       urc;           /* upper right texture coordinate */
		vector2_t       llc;           /* lower left texture coordinate */
		vector2_t       lrc;           /* lower right texture coordinate */
    ...
    struct _element_t
    {
        ...
        vector2_t* translation;         /* translation, the address is used by the renderer to group elements for rendering */
    ...
    void        element_settranslation( element_t* element , vector2_t* translation );
    ...
    void        element_collectelements( element_t* element , vector2_t parent, mtvec_t* vector );
