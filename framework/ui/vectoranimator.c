    ...
    void vectoranimator_init( vectoranimator_t* animator , vector2_t startvalue , vector2_t endvalue , uint32_t starttime , uint32_t endtime , char type )
    {
        animator->type = type;
        animator->running = 0;
        ...
        animator->delta = vector2_sub( endvalue , startvalue );
    ...
    vector2_t vectoranimator_step( vectoranimator_t* animator , uint32_t time )
    {
        ...
        {
            animator->actual = vector2_add( animator->startvalue , animator->delta );
            animator->running = 0;
        }
