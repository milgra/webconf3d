    ...
    typedef struct _cursor_t
    {
        ...
        vector2_t   targetpos;      /* cursor elements target position */
        vector2_t   actualpos;      /* cusros elements actual advised position */
        vector2_t   curspos;        /* cursor elements reference position */
